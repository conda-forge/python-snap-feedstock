...
pixi add python-snap
# for installing globally
pixi global install python-snap
```
...
It is possible to list all of the versions of `python-snap` available on your platform:
...
```
pixi search python-snap --channel conda-forge
```
